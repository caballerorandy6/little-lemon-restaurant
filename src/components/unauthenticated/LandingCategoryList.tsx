...
export default function LandingCategories() {
  ...
  return (
    <section
      id="menu"
      ref={ref}
      className="mx-auto max-w-7xl px-6 py-16 lg:px-8 border rounded-4xl border-gray-300/50 shadow-md"
    >
      ...
      <div className="flex justify-center mt-12">
        <Link
          href="/menu"
          className="inline-block rounded-lg bg-yellow-400 px-6 py-3 text-lg font-semibold text-black hover:bg-yellow-300 transition"
        >
          View Full Menu
        </Link>
      </div>

      <div className="mt-20 grid gap-10 lg:grid-cols-2 text-gray-700 text-lg leading-relaxed">
        <p>
